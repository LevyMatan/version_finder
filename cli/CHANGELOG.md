...
- **core**: Remove unused SUBMODULE_PATTERN regex and simplify submodule extraction
  ([`21af6fb`](https://github.com/LevyMatan/version_finder/commit/21af6fb5c137c1dcee727ced2017fb4709ed592e))

- **core,gui,cli**: Simplify logger initialization and enhance log directory handling
  ([`4ede0a3`](https://github.com/LevyMatan/version_finder/commit/4ede0a3683309a27a4d9bf6d9818cbd6ae0c7826))
...
- **gui**: Correct string formatting in log output for submodule absence message
  ([`757bc83`](https://github.com/LevyMatan/version_finder/commit/757bc836c63cfbf9270cfceff56783993febfd55))
...
- **vscode**: Update launch configuration to use debugpy for Python debugging
  ([`968f5df`](https://github.com/LevyMatan/version_finder/commit/968f5dfa546205aea04cb77970342732d0abe14e))

### Chores

- **ci**: Update coverage command to use xvfb-run for headless execution
  ([`cdeccbc`](https://github.com/LevyMatan/version_finder/commit/cdeccbcf27b216ff5fdb428c4797f23b1ccf878f))

- **ci**: Update coverage reporting in GitHub Actions workflow
  ([`7a80e6f`](https://github.com/LevyMatan/version_finder/commit/7a80e6f4c9db99aee1bdc7c833cb8c4a526a82a8))

- Installed xvfb for headless execution. - Modified coverage report command to run with xvfb.

- **core-cli-gui**: :art: Clean up whitespace and improve readability in test files
  ([`1843d35`](https://github.com/LevyMatan/version_finder/commit/1843d35165fee7e7fb4b67e49b3667f592e7dc59))

- **gui**: Update installation script and add tree-ignore script
  ([`8aaa807`](https://github.com/LevyMatan/version_finder/commit/8aaa80713eeaa4cb3b7801a1ddb255e5b63a3dca))

- Modified install.ps1 to specify the GUI installation path. - Updated pyproject.toml to clean up
  unnecessary sections. - Added tree-ignore.ps1 for better directory management. - Enhanced setup.py
  to specify package dependencies. - Introduced test_gui_version.py for version validation in GUI.

- **infra**: Add 'list' to make, remove unused imports
  ([`2f35cf0`](https://github.com/LevyMatan/version_finder/commit/2f35cf0e6c5ded7b3286a74c590535160204e944))

chore(makefile): Add list target to display Makefile targets chore(cli): Remove unused imports and
  improve logging messages chore(logger): Clean up unused traceback import chore(tests): Remove
  unused imports in test files chore(gui): Remove unused imports in GUI modules

- **release-core**: 10.3.1
  ([`039be11`](https://github.com/LevyMatan/version_finder/commit/039be110281133032116f81dfc66abfaad06ebf9))

Automatically generated by python-semantic-release

- **release-core**: 10.3.2
  ([`75623f6`](https://github.com/LevyMatan/version_finder/commit/75623f6a9cc86da719bd9d36699b04607efa1191))

Automatically generated by python-semantic-release

- **release-gui**: 2.3.0
  ([`54a5656`](https://github.com/LevyMatan/version_finder/commit/54a5656facab94456da8e38f6d2d83d12f9a41a5))

Automatically generated by python-semantic-release

- **release-gui**: 2.3.1
  ([`a05e08c`](https://github.com/LevyMatan/version_finder/commit/a05e08c56b0b5ba6f47b82d08fe7d39af5876fb1))

Automatically generated by python-semantic-release

- **release-gui**: 2.3.2
  ([`212d057`](https://github.com/LevyMatan/version_finder/commit/212d057e64f2936fc2d91beecb8a9d1ce7af0904))

Automatically generated by python-semantic-release

- **release-gui**: 2.3.3
  ([`5819e01`](https://github.com/LevyMatan/version_finder/commit/5819e019890bae578aed8999bd6e9aa632949fdf))

Automatically generated by python-semantic-release

- **tests**: Refactor coverage commands in Makefile and update CI workflow
  ([`6ccdff7`](https://github.com/LevyMatan/version_finder/commit/6ccdff72df2e50f9b16a7b2771bfc9abba172b63))

- Split coverage commands into separate targets for GUI, core, and CLI. - Added a combined coverage
  report target to aggregate results. - Updated GitHub Actions workflow to run the new combined
  coverage command.
...
- **version-finder**: Improve logging format for commit retrieval
  ([`1d83516`](https://github.com/LevyMatan/version_finder/commit/1d835161d12feb9a08706aebcddc14262b357bf7))

- **version-finder**: Improve logging format for version retrieval
  ([`5e6a60d`](https://github.com/LevyMatan/version_finder/commit/5e6a60df7462cc6b2a7d26d6d740deacd94c29bf))

- **version-finder**: Refactor logging format for commit search
  ([`3e52b40`](https://github.com/LevyMatan/version_finder/commit/3e52b40cbdad704ecc6d875cf428e7049d5c95e5))

### Refactoring

- **cli, core, gui**: Rename method for consistency in version commit retrieval
  ([`b651924`](https://github.com/LevyMatan/version_finder/commit/b651924e538a1c9144add70d35bc4ae3937c9b73))

- **cli, core, gui**: Rename methods for consistency and clarity; remove unused methods
  ([`81459ab`](https://github.com/LevyMatan/version_finder/commit/81459ab8f82ed51cd0536e4f7c9fb5f4f0a126a5))

- **core**: Remove unused version class and related parsing logic
  ([`baa346b`](https://github.com/LevyMatan/version_finder/commit/baa346b444147f59403665e419963b5e7e61fede))

- **gui**: Simplify submodule entry handling and improve placeholder text
  ([`b044a64`](https://github.com/LevyMatan/version_finder/commit/b044a64d83e3d4c6eec7abfa90b1aa9cf63911b0))
...
- **tests**: Simplify logger initialization in CLI and version finder tests
  ([`c84a143`](https://github.com/LevyMatan/version_finder/commit/c84a143608a9dbab0b9d310b2f660799b60f430c))
...
- **version_finder**: Update branch retrieval method and add tests for dirty repository handling
  ([`6e5a043`](https://github.com/LevyMatan/version_finder/commit/6e5a04386ff44d8470ebc87a5edc5947ce942d40))

### Testing

- **cli, core**: Add version format and command tests for CLI and core modules
  ([`dedebde`](https://github.com/LevyMatan/version_finder/commit/dedebde6153f3244467532a0978e57f099b17c2f))
...
- **release-core**: 10.1.0
  ([`c9cb74d`](https://github.com/LevyMatan/version_finder/commit/c9cb74d9c6fc28ca0088ee64a863c2cc96a4fb37))

Automatically generated by python-semantic-release

- **release-core**: 10.2.0
  ([`72ec914`](https://github.com/LevyMatan/version_finder/commit/72ec91432bd78f8b3a1d66f2cdfe419853a99853))

Automatically generated by python-semantic-release

- **release-core**: 10.3.0
  ([`fa02db4`](https://github.com/LevyMatan/version_finder/commit/fa02db422fff179e2f4990fd1aec422b8ca427e1))
