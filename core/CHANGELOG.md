...
- **gui**: :zap: alce os operations with Path, use decorator to ensure initialization
  ([`79ae8ed`](https://github.com/LevyMatan/version_finder/commit/79ae8ed7d94bf20936bdb48de0cf39e262b7edef))

### Chores

- **release-gui**: 2.2.1
  ([`941ab2e`](https://github.com/LevyMatan/version_finder/commit/941ab2e00fc5753099a14e26221ac0b73c051cc2))

Automatically generated by python-semantic-release

### Documentation

- **core**: :beers: Add type hint
  ([`c269b95`](https://github.com/LevyMatan/version_finder/commit/c269b9525597678df2c20ea982c53260b14a9d6f))

### Features

- **core**: :sparkles: Enhance version finder with command-line argument parsing and repository
  management
  ([`c8946ab`](https://github.com/LevyMatan/version_finder/commit/c8946ab9c9f681de160afddaca474970788fced2))

- Enhanced Error Handling - Implemented a worker process in the GUI for background operations,
  improving responsiveness. - Loading Spinner for Long Operations:
